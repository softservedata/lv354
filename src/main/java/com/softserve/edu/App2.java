...
public class App2 {
	public static final Logger logger = LoggerFactory.getLogger(App2.class); // org.slf4j.LoggerFactory
	//public static final Logger logger = Logger.getLogger(App2.class); // org.apache.log4j.Logger
