...
import com.softserve.edu.opencart.data.application.CartStatus;
...
//    }
	...
	public void setCartStatusIsEmpty(boolean Status) {
		cartStatus.setCartStatusIsEmpty(Status);
	}
	
	public boolean getCartStatusIsEmpty() {
		return cartStatus.isEmpty();
	}
